...
?><br>
                ...
                <div id="aside" class="col-md-3">
                    ...
                    <div class="aside">
                        ...
                        <div class="checkbox-filter">
                            <!-- /aside Widget --><? $APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"catalog2", 
	array(
	...
	array(
		...
		"COMPATIBLE_MODE" => "Y",
		"COMPONENT_TEMPLATE" => "another_template_cat_top1",
		"CONVERT_CURRENCY" => "N",
                ...
                <div id="store" class="col-md-9">
                    ...
                    <div class="store-filter clearfix">
                        <div class="store-sort">
                            <label>
                                Sort By:
                                <select class="input-select" onchange="if (this.value) window.location.href=this.value">
                                    <option disabled selected value>select an option</option>
                                    <?php
                                    $sort_properties = [
                                           'Дате' => '?sort=timestamp_x&method=desc',
                                           'Названию' => '?sort=name&method=asc',
                                           'Цене' => '?sort=catalog_PRICE_1&method=asc'
                                            ];

                                    foreach ($sort_properties as $key => $value) : ?>
                                    <option value="<?=$arResult["SECTION_PAGE_URL"]?>.<?=$value?>"><?=$key?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <label>
                                Show:
                                <select class="input-select" onchange="if (this.value) window.location.href=this.value">
                                    <option disabled selected value>BY</option>
                                    <?php
                                    $arAvailableCounts = array(20, 50, 100);
                                    foreach($arAvailableCounts as $value):?>
                                    <option value="<?=$APPLICATION->GetCurPageParam('showBy='.$value, array('showBy'));?>"><?=$value?></option>
                                    <?endforeach;?>
                                </select>
                                <?
...
if (!$pageElementCount){
                    ...
                    <!-- /store top filter --> <!-- store products -->
	...
	array(
		...
		"ELEMENT_SORT_FIELD2" => $_GET["method"],
		"ELEMENT_SORT_ORDER" => "asc",
		"ELEMENT_SORT_ORDER2" => "desc",
		"ENLARGE_PRODUCT" => "STRICT",
	...
	false
                    ...
                    <!-- /product --> <!-- /store products --> <!-- store bottom filter -->
                ...
                <div class="col-md-12">
                    <div class="newsletter">
                        ...
                        <form action="" method="post" id="cform">
                            <input id="SUBSCRIBE" value="Y" type="hidden"> <input type="email" class="input"
                                                                                  id="frm_subscribe"
                                                                                  placeholder="Enter Your Email">
                            <button type="button" id="select_btn" class="newsletter-btn"><i class="fa fa-envelope"></i>
                                Subscribe
                            </button>
                        </form>
